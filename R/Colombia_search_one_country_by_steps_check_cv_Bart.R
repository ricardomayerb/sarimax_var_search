...
saveRDS(VAR_data_for_estimation , "./data/VAR_data_Colombia.rds")
...
var_res_6 <- try_sizes_vbls_lags(vec_size = 5, 
                                 ...
                                 rgdp_level_ts = rgdp_level_ts, 
                                 target_v = target_rgdp,
                                 pre_selected_v = c("imp_consumer_d"), 
                                 is_cv = TRUE,
                                 training_length = train_span,
                                 h_max = fc_horizon, n_cv = number_of_cv,
                                 bt_factor = 0, maxlag_ccm = 8,
...
models_and_accu_12345 <- rbind(models_and_accu_1, models_and_accu_2, models_and_accu_3, models_and_accu_4, models_and_accu_5, models_and_accu_6) %>% 
