...
do_univariate_fit_fcs <- function(rgdp_data, models = "all", n_offset = 0, 
                               freq = 4, h_max = 8) {
  ...
  p_level <- autoplot(rgdp_data) + 
    autolayer(fc_arima_3, PI = FALSE) + 
    autolayer(fc_arima_4, PI = FALSE) + 
    autolayer(exp(fc_arima_2$mean))  + 
    autolayer(exp(fc_arima_1$mean))  + 
    autolayer(fc_ets_6, PI = FALSE) + 
    autolayer(fc_ets_7, PI = FALSE) +
...
univariate_rgpd_obj <- do_univariate_fit_fcs(rgdp_ts)

univariate_rgpd_obj_4 <- do_univariate_fit_fcs(rgdp_ts, n_offset = 4)

univariate_rgpd_obj_8 <- do_univariate_fit_fcs(rgdp_ts, n_offset = 8)

univariate_rgpd_obj_12 <- do_univariate_fit_fcs(rgdp_ts, n_offset = 12)
