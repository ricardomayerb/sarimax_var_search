...
n_best <- 5
number_of_cv <- 8
fc_horizon <- 6 # 6 is the max Ecuador can take with train span lowered to 21 from 25
train_span <- 21
...
saveRDS(models_and_accu_12345, "./data/Uruguay_by_step_12345.rds")


cv_objects_12345 <- rbind(cv_objects_1, cv_objects_2, cv_objects_3, cv_objects_4, cv_objects_4b, cv_objects_5)

saveRDS(cv_objects_12345, "./data/Uruguay_by_step_12345_cv_objects.rds")
