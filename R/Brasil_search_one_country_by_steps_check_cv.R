...
saveRDS(VAR_data_for_estimation , "./data/VAR_data_Brasil.rds")
...
# all VARs size 3, 4.315333 mintutes
tictoc::tic()
...
# all VARs size 4, 2 choices of lag, 22.46 min
tictoc::tic()
...
# or 1 pre_chosen size 4, 3 choices of lag, 3.438833 minutes
...
# All possibilities at lags 2 and 3, 173.9323 min
...
saveRDS(models_and_accu_12345, "./data/Brasil_by_step_12345.rds")


cv_objects_12345 <- rbind(cv_objects_1, cv_objects_2, cv_objects_3, cv_objects_4, cv_objects_5)

saveRDS(cv_objects_12345, "./data/Brasil_by_step_12345_cv_objects.rds")
