...
manu_arimax_igae0 <- Arima(y = procrustean_y, xreg = procrustean_x0_and_trend,
                           order = rgdp_order_list_auto$order,
                           seasonal = rgdp_order_list_auto$seasonal,
                           include.constant = rgdp_order_list_auto$mean_logical,
                           method = "CSS-ML")

manu_arimax_igae1 <- Arima(y = procrustean_y, xreg = procrustean_x1_and_trend,
                           order = rgdp_order_list_auto$order,
                           seasonal = rgdp_order_list_auto$seasonal,
                           include.constant = rgdp_order_list_auto$mean_logical,
                           method = "CSS-ML")
...
manu_arimax_igae2 <- Arima(y = procrustean_y, xreg = procrustean_x2_and_trend,
                           order = rgdp_order_list_auto$order,
                           seasonal = rgdp_order_list_auto$seasonal,
                           include.constant = rgdp_order_list_auto$mean_logical,
                           method = "CSS-ML")
