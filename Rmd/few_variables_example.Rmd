...
if (use_demetra) {
  ...
  if (use_dm_force_constant) {
    ...
    uncond_fc_mean_dm_s <- rgdp_uncond_fc_mean
...
uncond_fc_mean_dm_r <- rgdp_uncond_fc_mean
...
uncond_fc_mean_auto <- rgdp_uncond_fc_mean
...
arimax_and_fcs <- get_arimax_and_fcs(y_ts = this_rgdp_ts, 
                          ...
                          max_x_lag = max_x_lag,
                          rgdp_order_list = rgdp_order_list_dm_r,
                          h_max = h_max, data_is_log_log = is_log_log)
toc()
...
tic()
fcs_aggr_transf_auto <- aggregate_and_transform_fcs(
  arimax_and_fcs_auto, cv_cond_uncond_auto, rgdp_ts = this_rgdp_ts,
  rgdp_uncond_fc_mean = uncond_fc_mean_auto, test_length = test_length,
  h_max = 9, data_is_log_log = is_log_log)
toc()

rmse_tbl <- fcs_aggr_transf_auto$compare_rmse
rmse_tbl_yoy <- fcs_aggr_transf_auto$compare_rmse_yoy
rmse_tbl_logdiff <- fcs_aggr_transf_auto$compare_rmse_logdiff
rmse_tbl_percent <- fcs_aggr_transf_auto$compare_rmse_percent
...
rmse_tbl_auto <- fcs_aggr_transf_auto$compare_rmse
rmse_tbl_yoy_auto <- fcs_aggr_transf_auto$compare_rmse_yoy
rmse_tbl_logdiff_auto <- fcs_aggr_transf_auto$compare_rmse_logdiff
rmse_tbl_percent_auto <- fcs_aggr_transf_auto$compare_rmse_percent

# rmse_tbl_logdiff_auto
# rmse_tbl_percent_auto
# rmse_tbl_auto
# rmse_tbl_yoy_auto
...
tic()
fcs_aggr_transf_dm_r <- aggregate_and_transform_fcs(
  arimax_and_fcs_dm_r, cv_cond_uncond_dm_r, rgdp_ts = this_rgdp_ts,
  rgdp_uncond_fc_mean = uncond_fc_mean_dm_r, test_length = test_length,
  h_max = 9, data_is_log_log = is_log_log)
toc()

rmse_tbl_dm_r <- fcs_aggr_transf_dm_r$compare_rmse
rmse_tbl_yoy_dm_r <- fcs_aggr_transf_dm_r$compare_rmse_yoy
rmse_tbl_logdiff_dm_r <- fcs_aggr_transf_dm_r$compare_rmse_logdiff
rmse_tbl_percent_dm_r <- fcs_aggr_transf_dm_r$compare_rmse_percent

# rmse_tbl_logdiff_dm_r
# rmse_tbl_percent_dm_r
# rmse_tbl_dm_r
# rmse_tbl_yoy_dm_r
...
tic()
fcs_aggr_transf_dm_s <- aggregate_and_transform_fcs(
  arimax_and_fcs_dm_s, cv_cond_uncond_dm_s, rgdp_ts = this_rgdp_ts,
  rgdp_uncond_fc_mean = uncond_fc_mean_dm_s, test_length = test_length,
  h_max = 9, data_is_log_log = is_log_log)
toc()

rmse_tbl_dm_s <- fcs_aggr_transf_dm_s$compare_rmse
rmse_tbl_yoy_dm_s <- fcs_aggr_transf_dm_s$compare_rmse_yoy
rmse_tbl_logdiff_dm_s <- fcs_aggr_transf_dm_s$compare_rmse_logdiff
rmse_tbl_percent_dm_s <- fcs_aggr_transf_dm_s$compare_rmse_percent

# rmse_tbl_logdiff_dm_s
# rmse_tbl_percent_dm_s
# rmse_tbl_dm_s
# rmse_tbl_yoy_dm_s
...
yoy_fc_unc <- fcs_aggr_transf_auto$yoy_rgdp_data_and_uncond_fc
yoy_fc_ldw <- fcs_aggr_transf_auto$yoy_fc_using_accu_logdiff_weights
yoy_fc_lvw <- fcs_aggr_transf_auto$yoy_fc_using_accu_level_weights
yoy_fc_yw <- fcs_aggr_transf_auto$yoy_fc_using_accu_yoy_weights

py_auto <- autoplot(yoy_fc_unc, series = "uncond") + 
  autolayer(yoy_fc_ldw) + 
  autolayer(yoy_fc_lvw) + 
  autolayer(yoy_fc_yw)

fc_unc <- fcs_aggr_transf_auto$rgdp_data_and_uncond_fc
fc_ldw <- fcs_aggr_transf_auto$fcs_using_logdiff_weights
fc_lvw <- fcs_aggr_transf_auto$weigthed_fcs
fc_yw <- fcs_aggr_transf_auto$fcs_using_yoy_weights

pl_auto <- autoplot(fc_unc, series = "uncond") + 
  autolayer(fc_ldw) + 
  autolayer(fc_lvw) + 
  autolayer(fc_yw)
