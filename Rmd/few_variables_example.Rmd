...
x_start <-  stats::start(internal_mdata_ext_ts_dm_r)
x_end <-  stats::end(internal_mdata_ext_ts_dm_r)
...
procrustean_x <- window(internal_mdata_ext_ts_dm_r,
                        start = max_start, end = min_end)

manu_arimax_igae0 <- Arima(y = procrustean_y, xreg = procrustean_x,
