...
edma <- ts.union(m_external_mdata_ext_ts_auto, manual_ext_ext_auto,
                 manual_ext_ext_auto_slow, manual_ext_ext_dm_r) 
colnames(edma) <- c("myfun", "manual", "manual_slow", "manual_dm_r")
print(edma)

edma_yoy <- 100 * make_yoy_ts(edma, freq = 12, is_log = TRUE)
colnames(edma_yoy) <- c("myfun", "manual", "manual_slow", "manual_dm_r")
print(edma_yoy)
